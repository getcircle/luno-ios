...
struct AppStrings {
    ...
    static let QuickActionNonePlaceholder = NSLocalizedString("Search people, teams, skills, etc.", comment: "Placeholder text for search field used to search people, teams and skills.")
