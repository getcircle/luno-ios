...
struct AppStrings {
    ...
    static let QuickActionNonePlaceholder = NSLocalizedString("Find people, teams, and locations", comment: "Placeholder text for search field used to search people, teams and skills.")
